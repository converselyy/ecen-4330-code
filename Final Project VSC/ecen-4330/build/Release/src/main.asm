...
;	.\src\main.c:4: uint8_t keypad[4][4] =	{{'1','4','7','E'},
	mov	_keypad,#0x31
...
;	.\src\main.c:9: __xdata uint8_t* lcd_address = (uint8_t __xdata*) __LCD_ADDRESS__;
	mov	_lcd_address,#0x00
	mov	(_lcd_address + 1),#0x40
;	.\src\main.c:10: __xdata uint8_t* seg7_address = (uint8_t __xdata*) __SEG_7_ADDRESS__;
...
;------------------------------------------------------------
;	.\src\main.c:48: void iowrite8 (uint8_t __xdata* map_address, uint8_t d) {
;	-----------------------------------------
;	 function iowrite8
;	-----------------------------------------
_iowrite8:
...
;------------------------------------------------------------
;	.\src\main.c:56: void delay (int16_t d)
;	-----------------------------------------
;	 function delay
;	-----------------------------------------
_delay:
...
00107$:
	...
	subb	a,b
	jnc	00109$
;	.\src\main.c:61: for (j=0;j<1000;j++);
	mov	r2,#0xe8
	mov	r3,#0x03
00105$:
	dec	r2
...
;------------------------------------------------------------
;	.\src\main.c:68: void writeRegister8 (uint8_t a, uint8_t d) {
;	-----------------------------------------
;	 function writeRegister8
;	-----------------------------------------
_writeRegister8:
	mov	r7,dpl
;	.\src\main.c:69: CD = __CMD__;
;	assignBit
	clr	_P3_5
;	.\src\main.c:70: write8(a);
;	assignBit
	setb	_P3_4
...
;	assignBit
	clr	_P3_4
;	.\src\main.c:71: CD = __DATA__;
;	assignBit
	setb	_P3_5
;	.\src\main.c:72: write8(d);
;	assignBit
	setb	_P3_4
	mov	dpl,_lcd_address
	mov	dph,(_lcd_address + 1)
...
;------------------------------------------------------------
;	.\src\main.c:77: void writeRegister16 (uint16_t a, uint16_t d) {
;	-----------------------------------------
...
_writeRegister16:
	mov	r6,dpl
	mov	r7,dph
;	.\src\main.c:79: hi = (a) >> 8;
	mov	ar5,r7
;	.\src\main.c:80: lo = (a);
;	.\src\main.c:81: write8Reg(hi);
;	assignBit
	clr	_P3_5
;	assignBit
	setb	_P3_4
...
;------------------------------------------------------------
;	.\src\main.c:91: void setCursor (uint16_t x, uint16_t y) {
;	-----------------------------------------
;	 function setCursor
;	-----------------------------------------
_setCursor:
...
;x                         Allocated to registers 
;------------------------------------------------------------
;	.\src\main.c:95: void setTextColor (uint16_t x, uint16_t y) {
;	-----------------------------------------
...
;------------------------------------------------------------
;	.\src\main.c:100: void setTextSize (uint8_t s) {
;	-----------------------------------------
;	 function setTextSize
;	-----------------------------------------
_setTextSize:
;	.\src\main.c:101: if (s > 8) return;
	mov	a,dpl
	mov	r7,a
	add	a,#0xff - 0x08
	jnc	00102$
	ret
00102$:
;	.\src\main.c:102: textsize = (s>0) ? s : 1 ;
	mov	a,r7
	jz	00105$
	mov	ar6,r7
	mov	r7,#0x00
...
;------------------------------------------------------------
;	.\src\main.c:105: void setRotation (uint8_t flag) {
;	-----------------------------------------
;	 function setRotation
;	-----------------------------------------
_setRotation:
;	.\src\main.c:106: switch(flag) {
	mov	a,dpl
	mov	r7,a
	add	a,#0xff - 0x03
	jc	00105$
...
00115$:
	...
	sjmp	00104$
00101$:
;	.\src\main.c:108: flag = (ILI9341_MADCTL_MX | ILI9341_MADCTL_BGR);
	mov	r7,#0x48
;	.\src\main.c:109: _width = TFTWIDTH;
	mov	__width,#0xf0
	mov	(__width + 1),#0x00
;	.\src\main.c:110: _height = TFTHEIGHT;
	mov	__height,#0x40
	mov	(__height + 1),#0x01
;	.\src\main.c:111: break;
;	.\src\main.c:112: case 1:
	sjmp	00106$
00102$:
;	.\src\main.c:113: flag = (ILI9341_MADCTL_MV | ILI9341_MADCTL_BGR);
	mov	r7,#0x28
;	.\src\main.c:114: _width = TFTHEIGHT;
	mov	__width,#0x40
	mov	(__width + 1),#0x01
;	.\src\main.c:115: _height = TFTWIDTH;
	mov	__height,#0xf0
	mov	(__height + 1),#0x00
;	.\src\main.c:116: break;
;	.\src\main.c:117: case 2:
	sjmp	00106$
00103$:
;	.\src\main.c:118: flag = (ILI9341_MADCTL_MY | ILI9341_MADCTL_BGR);
	mov	r7,#0x88
;	.\src\main.c:119: _width = TFTWIDTH;
	mov	__width,#0xf0
	mov	(__width + 1),#0x00
;	.\src\main.c:120: _height = TFTHEIGHT;
	mov	__height,#0x40
	mov	(__height + 1),#0x01
;	.\src\main.c:121: break;
;	.\src\main.c:122: case 3:
	sjmp	00106$
00104$:
;	.\src\main.c:123: flag = (ILI9341_MADCTL_MX | ILI9341_MADCTL_MY | ILI9341_MADCTL_MV | ILI9341_MADCTL_BGR);
	mov	r7,#0xe8
;	.\src\main.c:124: _width = TFTHEIGHT;
	mov	__width,#0x40
	mov	(__width + 1),#0x01
;	.\src\main.c:125: _height = TFTWIDTH;
	mov	__height,#0xf0
	mov	(__height + 1),#0x00
;	.\src\main.c:126: break;
;	.\src\main.c:127: default:
	sjmp	00106$
00105$:
;	.\src\main.c:128: flag = (ILI9341_MADCTL_MX | ILI9341_MADCTL_BGR);
	mov	r7,#0x48
;	.\src\main.c:129: _width = TFTWIDTH;
	mov	__width,#0xf0
	mov	(__width + 1),#0x00
;	.\src\main.c:130: _height = TFTHEIGHT;
	mov	__height,#0x40
	mov	(__height + 1),#0x01
;	.\src\main.c:132: }
00106$:
;	.\src\main.c:133: writeRegister8(ILI9341_MEMCONTROL, flag);
...
;------------------------------------------------------------
;	.\src\main.c:136: void setAddress (uint16_t x1,uint16_t y1,uint16_t x2,uint16_t y2) {
;	-----------------------------------------
;	 function setAddress
;	-----------------------------------------
_setAddress:
...
;	assignBit
	clr	_P3_4
;	.\src\main.c:138: write8Data(x1 >> 8);
;	assignBit
	setb	_P3_5
;	assignBit
	setb	_P3_4
...
;	assignBit
	clr	_P3_4
;	.\src\main.c:140: write8Data(x2 >> 8);
;	assignBit
	setb	_P3_5
;	assignBit
	setb	_P3_4
...
;	assignBit
	clr	_P3_4
;	.\src\main.c:144: write8Data(y1 >> 8);
;	assignBit
	setb	_P3_5
;	assignBit
	setb	_P3_4
...
;	assignBit
	clr	_P3_4
;	.\src\main.c:146: write8Data(y2 >> 8);
;	assignBit
	setb	_P3_5
;	assignBit
	setb	_P3_4
...
;------------------------------------------------------------
;	.\src\main.c:150: void TFT_LCD_INIT (void) {
;	-----------------------------------------
;	 function TFT_LCD_INIT
;	-----------------------------------------
_TFT_LCD_INIT:
;	.\src\main.c:151: _width = TFTWIDTH;
	mov	__width,#0xf0
	mov	(__width + 1),#0x00
;	.\src\main.c:152: _height = TFTHEIGHT;
	mov	__height,#0x40
	mov	(__height + 1),#0x01
;	.\src\main.c:154: IOM = 0;
;	assignBit
	clr	_P3_4
;	.\src\main.c:155: CD = 1;
;	assignBit
	setb	_P3_5
;	.\src\main.c:157: write8Reg(0x00);
;	assignBit
	clr	_P3_5
;	assignBit
	setb	_P3_4
...
;	assignBit
	clr	_P3_4
;	.\src\main.c:158: write8Data(0x00);
;	assignBit
	setb	_P3_5
;	assignBit
	setb	_P3_4
...
;	assignBit
	clr	_P3_4
;	.\src\main.c:159: write8Data(0x00);
;	assignBit
	setb	_P3_5
;	assignBit
	setb	_P3_4
...
;	assignBit
	clr	_P3_4
;	.\src\main.c:160: write8Data(0x00);
;	assignBit
	setb	_P3_5
;	assignBit
	setb	_P3_4
...
;	assignBit
	clr	_P3_4
;	.\src\main.c:161: delay(200);
	mov	dptr,#0x00c8
	lcall	_delay
;	.\src\main.c:163: writeRegister8(ILI9341_SOFTRESET, 0);
	mov	_writeRegister8_PARM_2,#0x00
	mov	dpl,#0x01
	lcall	_writeRegister8
;	.\src\main.c:164: delay(50);
	mov	dptr,#0x0032
	lcall	_delay
;	.\src\main.c:165: writeRegister8(ILI9341_DISPLAYOFF, 0);
	mov	_writeRegister8_PARM_2,#0x00
	mov	dpl,#0x28
	lcall	_writeRegister8
;	.\src\main.c:166: delay(10);
	mov	dptr,#0x000a
	lcall	_delay
;	.\src\main.c:168: writeRegister8(ILI9341_POWERCONTROL1, 0x23);
	mov	_writeRegister8_PARM_2,#0x23
	mov	dpl,#0xc0
	lcall	_writeRegister8
;	.\src\main.c:169: writeRegister8(ILI9341_POWERCONTROL2, 0x11);
	mov	_writeRegister8_PARM_2,#0x11
	mov	dpl,#0xc1
	lcall	_writeRegister8
;	.\src\main.c:170: write8Reg(ILI9341_VCOMCONTROL1);
;	assignBit
	clr	_P3_5
;	assignBit
	setb	_P3_4
...
;	assignBit
	clr	_P3_4
;	.\src\main.c:171: write8Data(0x3d);
;	assignBit
	setb	_P3_5
;	assignBit
	setb	_P3_4
...
;	assignBit
	clr	_P3_4
;	.\src\main.c:172: write8Data(0x30);
;	assignBit
	setb	_P3_5
;	assignBit
	setb	_P3_4
...
;	assignBit
	clr	_P3_4
;	.\src\main.c:173: writeRegister8(ILI9341_VCOMCONTROL2, 0xaa);
	mov	_writeRegister8_PARM_2,#0xaa
	mov	dpl,#0xc7
	lcall	_writeRegister8
;	.\src\main.c:174: writeRegister8(ILI9341_MEMCONTROL, ILI9341_MADCTL_MY | ILI9341_MADCTL_BGR);
	mov	_writeRegister8_PARM_2,#0x88
	mov	dpl,#0x36
	lcall	_writeRegister8
;	.\src\main.c:175: write8Reg(ILI9341_PIXELFORMAT);
;	assignBit
	clr	_P3_5
;	assignBit
	setb	_P3_4
...
;	assignBit
	clr	_P3_4
;	.\src\main.c:176: write8Data(0x55);write8Data(0x00);
;	assignBit
	setb	_P3_5
;	assignBit
	setb	_P3_4
...
;	assignBit
	clr	_P3_4
;	.\src\main.c:177: writeRegister16(ILI9341_FRAMECONTROL, 0x001B);
	mov	_writeRegister16_PARM_2,#0x1b
	mov	(_writeRegister16_PARM_2 + 1),#0x00
	mov	dptr,#0x00b1
	lcall	_writeRegister16
;	.\src\main.c:179: writeRegister8(ILI9341_ENTRYMODE, 0x07);
	mov	_writeRegister8_PARM_2,#0x07
	mov	dpl,#0xb7
	lcall	_writeRegister8
;	.\src\main.c:181: writeRegister8(ILI9341_SLEEPOUT, 0);
	mov	_writeRegister8_PARM_2,#0x00
	mov	dpl,#0x11
	lcall	_writeRegister8
;	.\src\main.c:182: delay(150);
	mov	dptr,#0x0096
	lcall	_delay
;	.\src\main.c:183: writeRegister8(ILI9341_DISPLAYON, 0);
	mov	_writeRegister8_PARM_2,#0x00
	mov	dpl,#0x29
	lcall	_writeRegister8
;	.\src\main.c:184: delay(500);
	mov	dptr,#0x01f4
	lcall	_delay
;	.\src\main.c:185: setAddress(0,0,_width-1,_height-1);
	mov	r6,__width
	mov	r7,(__width + 1)
	dec	r6
	cjne	r6,#0xff,00103$
...
;------------------------------------------------------------
;	.\src\main.c:188: void drawPixel(uint16_t x3,uint16_t y3,uint16_t color1)
;	-----------------------------------------
;	 function drawPixel
;	-----------------------------------------
_drawPixel:
	mov	r6,dpl
	mov	r7,dph
;	.\src\main.c:190: setAddress(x3,y3,x3+1,y3+1);
	mov	ar4,r6
	mov	ar5,r7
	inc	r4
	cjne	r4,#0x00,00103$
...
00104$:
	...
	mov	dph,r7
	lcall	_setAddress
;	.\src\main.c:192: CD=0; write8(0x2C);
;	assignBit
	clr	_P3_5
;	assignBit
	setb	_P3_4
...
;	assignBit
	setb	_P3_5
;	.\src\main.c:195: write8(color1>>8);write8(color1);
;	assignBit
	setb	_P3_4
	mov	dpl,_lcd_address
	mov	dph,(_lcd_address + 1)
...
;------------------------------------------------------------
;	.\src\main.c:198: void drawCircle(int16_t x0, int16_t y0, int16_t r, uint16_t color){
;	-----------------------------------------
;	 function drawCircle
;	-----------------------------------------
_drawCircle:
...
;	.\src\main.c:201: int ddF_y = -2 * r;
	...
	mov	r2,dpl
	mov	r3,dph
;	.\src\main.c:203: int y = r;
	mov	r0,_drawCircle_PARM_3
	mov	r1,(_drawCircle_PARM_3 + 1)
;	.\src\main.c:205: drawPixel(x0  , y0+r, color);
	...
	push	ar0
	lcall	_drawPixel
;	.\src\main.c:206: drawPixel(x0  , y0-r, color);
	...
	mov	dph,(_drawCircle_x0_65536_103 + 1)
	lcall	_drawPixel
;	.\src\main.c:207: drawPixel(x0+r, y0  , color);
	mov	a,_drawCircle_PARM_3
	...
	mov	(_drawPixel_PARM_3 + 1),(_drawCircle_PARM_4 + 1)
	lcall	_drawPixel
;	.\src\main.c:208: drawPixel(x0-r, y0  , color);
...
;	.\src\main.c:218: f += ddF_x;
	...
	addc	a,(_drawCircle_f_65536_104 + 1)
	mov	(_drawCircle_f_65536_104 + 1),a
;	.\src\main.c:220: drawPixel(x0 + x, y0 + y, color);
	...
	pop	ar4
	pop	ar5
;	.\src\main.c:221: drawPixel(x0 - x, y0 + y, color);
	mov	a,r4
	clr	c
	...
	pop	ar4
	pop	ar5
;	.\src\main.c:222: drawPixel(x0 + x, y0 - y, color);
	mov	a,r2
	clr	c
	subb	a,r0
	mov	r6,a
	...
	pop	ar6
	pop	ar7
;	.\src\main.c:223: drawPixel(x0 - x, y0 - y, color);
	mov	_drawPixel_PARM_2,r6
	mov	(_drawPixel_PARM_2 + 1),r7
	mov	_drawPixel_PARM_3,_drawCircle_PARM_4
	mov	(_drawPixel_PARM_3 + 1),(_drawCircle_PARM_4 + 1)
	...
	pop	ar4
	pop	ar5
;	.\src\main.c:224: drawPixel(x0 + y, y0 + x, color);
	mov	a,r0
	add	a,r4
	mov	r6,a
	mov	a,r1
	...
	pop	ar6
	pop	ar7
;	.\src\main.c:225: drawPixel(x0 - y, y0 + x, color);
	mov	a,r4
	clr	c
	subb	a,r0
	mov	r4,a
	...
	pop	ar2
	pop	ar3
;	.\src\main.c:226: drawPixel(x0 + y, y0 - x, color);
	mov	a,r2
	clr	c
	subb	a,_drawCircle_x_65536_104
	mov	r2,a
	...
	pop	ar4
	pop	ar5
;	.\src\main.c:227: drawPixel(x0 - y, y0 - x, color);
	mov	_drawPixel_PARM_2,r2
	mov	(_drawPixel_PARM_2 + 1),r3
	mov	_drawPixel_PARM_3,_drawCircle_PARM_4
	mov	(_drawPixel_PARM_3 + 1),(_drawCircle_PARM_4 + 1)
...
;------------------------------------------------------------
;	.\src\main.c:231: void testCircles (uint8_t radius, uint16_t color) {
;	-----------------------------------------
;	 function testCircles
;	-----------------------------------------
_testCircles:
	mov	r7,dpl
;	.\src\main.c:232: int  x, y, r2 = radius * 2, w = _width  + radius, h = _height + radius;
	mov	ar5,r7
	mov	r6,#0x00
	mov	a,r5
	add	a,r5
...
;	.\src\main.c:234: for(x=0; x<w; x+=r2) {
	mov	r1,#0x00
	mov	r2,#0x00
00107$:
	clr	c
	...
	subb	a,b
	jnc	00109$
;	.\src\main.c:235: for(y=0; y<h; y+=r2) {
	mov	r0,#0x00
	mov	r6,#0x00
00104$:
	clr	c
	...
	subb	a,b
	jnc	00108$
;	.\src\main.c:236: drawCircle(x, y, radius, color);
	mov	dpl,r1
	mov	dph,r2
...
;x                         Allocated to registers 
;------------------------------------------------------------
;	.\src\main.c:241: void fillRect (uint16_t x,uint16_t y,uint16_t w,uint16_t h,uint16_t color) {
;	-----------------------------------------
;	 function fillRect
;	-----------------------------------------
_fillRect:
	mov	r6,dpl
	mov	r7,dph
;	.\src\main.c:242: if ((x >= TFTWIDTH) || (y >= TFTHEIGHT))
	mov	ar4,r6
	mov	ar5,r7
	clr	c
	mov	a,r4
...
;	.\src\main.c:244: return;
	ret
00102$:
;	.\src\main.c:247: if ((x+w-1) >= TFTWIDTH)
...
00105$:
;	.\src\main.c:252: if ((y+h-1) >= TFTHEIGHT)
...
00107$:
;	.\src\main.c:257: setAddress(x, y, x+w-1, y+h-1);
	mov	a,_fillRect_PARM_3
	add	a,r6
	mov	r4,a
	mov	a,(_fillRect_PARM_3 + 1)
...
00111$:
	...
	orl	a,r4
	jz	00115$
;	.\src\main.c:267: write8(color>>8); write8(color);
;	assignBit
	setb	_P3_4
	mov	dpl,_lcd_address
	mov	dph,(_lcd_address + 1)
...
;lo                        Allocated to registers r6 
;------------------------------------------------------------
;	.\src\main.c:273: void fillScreen (uint16_t Color) {
;	-----------------------------------------
;	 function fillScreen
;	-----------------------------------------
_fillScreen:
	mov	r6,dpl
	mov	r7,dph
;	.\src\main.c:278: uint8_t  i, hi = Color >> 8,
	mov	ar5,r7
;	.\src\main.c:279: lo = Color;
;	.\src\main.c:282: setAddress(0,0,TFTWIDTH-1,TFTHEIGHT-1);
	clr	a
	mov	_setAddress_PARM_2,a
	mov	(_setAddress_PARM_2 + 1),a
...
;	assignBit
	setb	_P3_5
;	.\src\main.c:286: write8(hi); write8(lo);
;	assignBit
	setb	_P3_4
	mov	dpl,_lcd_address
	mov	dph,(_lcd_address + 1)
...
;	.\src\main.c:291: do {
	mov	r3,#0x10
00101$:
;	.\src\main.c:293: write8(hi); write8(lo);write8(hi); write8(lo);
;	assignBit
	setb	_P3_4
	mov	dpl,_lcd_address
	mov	dph,(_lcd_address + 1)
...
;	assignBit
	clr	_P3_4
;	.\src\main.c:294: write8(hi); write8(lo);write8(hi); write8(lo);
;	assignBit
	setb	_P3_4
	mov	dpl,_lcd_address
	mov	dph,(_lcd_address + 1)
...
;	assignBit
	clr	_P3_4
;	.\src\main.c:295: } while(--i);
	djnz	r3,00101$
	sjmp	00104$
00106$:
;	.\src\main.c:297: for (i = (char)len & 63; i--; ) {
	mov	r7,#0x3f
00109$:
	mov	ar4,r7
	dec	r7
	mov	a,r4
	jz	00111$
;	.\src\main.c:299: write8(hi); write8(lo);
;	assignBit
	setb	_P3_4
	mov	dpl,_lcd_address
	mov	dph,(_lcd_address + 1)
...
;------------------------------------------------------------
;	.\src\main.c:303: void drawChar (int16_t x, int16_t y, uint8_t c,uint16_t color, uint16_t bg, uint8_t size) {
;	-----------------------------------------
;	 function drawChar
;	-----------------------------------------
_drawChar:
...
00178$:
	...
	jnb	acc.7,00138$
00101$:
;	.\src\main.c:309: return;
	ret
;	.\src\main.c:314: for (i=0; i<6; i++ )
00138$:
	mov	a,#0x01
...
00124$:
;	.\src\main.c:318: if (i == 5)
	mov	a,#0x05
	cjne	a,_drawChar_i_65537_149,00107$
;	.\src\main.c:320: line = 0x0;
	mov	_drawChar_line_196609_151,#0x00
	sjmp	00136$
00107$:
;	.\src\main.c:324: line = pgm_read_byte(font+(c*5)+i);
	push	ar2
...
00122$:
;	.\src\main.c:331: if (line & 0x1)
	mov	a,_drawChar_line_196609_151
	jb	acc.0,00188$
	ljmp	00118$
00188$:
;	.\src\main.c:333: if (size == 1)
	mov	a,r3
	jz	00110$
;	.\src\main.c:335: drawPixel(x+i, y+j, color);
	mov	a,_drawChar_i_65537_149
	mov	r0,a
	rlc	a
	subb	a,acc
	...
	ljmp	00119$
00110$:
;	.\src\main.c:338: fillRect(x+(i*size), y+(j*size), size, size, color);
...
00191$:
	...
	ljmp	00119$
00118$:
;	.\src\main.c:340: } else if (bg != color)
	jnb	_drawChar_sloc0_1_0,00192$
	ljmp	00119$
00192$:
;	.\src\main.c:342: if (size == 1)
	mov	a,r2
	jz	00113$
;	.\src\main.c:344: drawPixel(x+i, y+j, bg);
	mov	a,_drawChar_i_65537_149
	mov	r0,a
	rlc	a
	subb	a,acc
	...
	sjmp	00119$
00113$:
;	.\src\main.c:348: fillRect(x+i*size, y+j*size, size, size, bg);
...
;------------------------------------------------------------
;	.\src\main.c:358: void write (uint8_t c)
;	-----------------------------------------
;	 function write
;	-----------------------------------------
_write:
...
;	.\src\main.c:360: if (c == '\n')
	cjne	r7,#0x0a,00105$
;	.\src\main.c:362: cursor_y += textsize*8;
	mov	r5,_textsize
	clr	a
	swap	a
	rr	a
	...
	mov	_cursor_y,r3
	mov	(_cursor_y + 1),r4
;	.\src\main.c:363: cursor_x  = 0;
	clr	a
	mov	_cursor_x,a
	mov	(_cursor_x + 1),a
	ret
00105$:
;	.\src\main.c:365: else if (c == '\r')
	cjne	r7,#0x0d,00119$
	ret
00119$:
;	.\src\main.c:370: drawChar(cursor_x, cursor_y, c, textcolor, textbgcolor, textsize);
	...
	mov	dph,(_cursor_x + 1)
	lcall	_drawChar
;	.\src\main.c:371: cursor_x += textsize*6;
...
;------------------------------------------------------------
;	.\src\main.c:375: void LCD_string_write (int8_t *str)
;	-----------------------------------------
...
_LCD_string_write:
	...
	mov	r6,dph
	mov	r7,b
;	.\src\main.c:378: for (i=0;str[i]!=0;i++)
	mov	r3,#0x00
	mov	r4,#0x00
00103$:
	mov	a,r3
...
;------------------------------------------------------------
;	.\src\main.c:384: void testRAM (uint8_t d) {
;	-----------------------------------------
;	 function testRAM
;	-----------------------------------------
_testRAM:
	mov	r7,dpl
;	.\src\main.c:388: for (i = __START_RAM__; i < __END_RAM__; i++) {
	mov	r3,#0x00
	mov	r4,#0x00
	mov	r5,#0x00
	mov	r6,#0x00
00102$:
;	.\src\main.c:389: IOM = 0;
;	assignBit
	clr	_P3_4
;	.\src\main.c:390: ram_address = (uint8_t __xdata*)(i);
	mov	dpl,r3
	mov	dph,r4
;	.\src\main.c:391: *ram_address = d;
	mov	a,r7
	movx	@dptr,a
;	.\src\main.c:392: IOM = 1;
;	assignBit
	setb	_P3_4
;	.\src\main.c:388: for (i = __START_RAM__; i < __END_RAM__; i++) {
	inc	r3
...
;------------------------------------------------------------
;	.\src\main.c:397: void freeType () {
;	-----------------------------------------
;	 function freeType
;	-----------------------------------------
_freeType:
;	.\src\main.c:398: uint8_t count = 0;
	mov	r7,#0x00
;	.\src\main.c:400: while (1) {
00105$:
;	.\src\main.c:403: if (count == 8) {
	cjne	r7,#0x08,00102$
;	.\src\main.c:405: count = 0;
	mov	r7,#0x00
;	.\src\main.c:406: write(d);
	mov	dpl,#0x0a
	push	ar7
	lcall	_write
	pop	ar7
	sjmp	00103$
00102$:
;	.\src\main.c:409: d = keyDetect();
	push	ar7
	lcall	_keyDetect
;	.\src\main.c:410: write(d);
	lcall	_write
	pop	ar7
00103$:
;	.\src\main.c:413: count++;
	inc	r7
;	.\src\main.c:415: }
	sjmp	00105$
;------------------------------------------------------------
...
;------------------------------------------------------------
;	.\src\main.c:417: uint8_t keyDetect () {
;	-----------------------------------------
;	 function keyDetect
;	-----------------------------------------
_keyDetect:
;	.\src\main.c:418: __KEYPAD_PORT__ = 0xF0;
	mov	_P1,#0xf0
;	.\src\main.c:419: do
00101$:
;	.\src\main.c:421: __KEYPAD_PORT__ = 0xF0;
	mov	_P1,#0xf0
;	.\src\main.c:422: colloc = __KEYPAD_PORT__;
	mov	_colloc,_P1
;	.\src\main.c:423: colloc&= 0xF0;
	anl	_colloc,#0xf0
;	.\src\main.c:424: } while (colloc != 0xF0);
	mov	a,#0xf0
	cjne	a,_colloc,00101$
;	.\src\main.c:428: do
00104$:
;	.\src\main.c:430: delay(20);
	mov	dptr,#0x0014
	lcall	_delay
;	.\src\main.c:431: colloc = (__KEYPAD_PORT__ & 0xF0);
	mov	a,_P1
	anl	a,#0xf0
	mov	_colloc,a
;	.\src\main.c:432: } while (colloc == 0xF0);
	mov	a,#0xf0
	cjne	a,_colloc,00178$
	sjmp	00104$
00178$:
;	.\src\main.c:434: delay(1);
	mov	dptr,#0x0001
	lcall	_delay
;	.\src\main.c:435: colloc = (__KEYPAD_PORT__ & 0xF0);
	mov	a,_P1
	anl	a,#0xf0
	mov	_colloc,a
;	.\src\main.c:436: } while (colloc == 0xF0);
	mov	a,#0xf0
	cjne	a,_colloc,00179$
	sjmp	00104$
00179$:
;	.\src\main.c:438: while (1)
00119$:
;	.\src\main.c:440: __KEYPAD_PORT__= 0xFE;
	mov	_P1,#0xfe
;	.\src\main.c:441: colloc = (__KEYPAD_PORT__ & 0xF0);
	mov	a,_P1
	anl	a,#0xf0
	mov	_colloc,a
;	.\src\main.c:442: if (colloc != 0xF0)
	mov	a,#0xf0
	cjne	a,_colloc,00180$
	sjmp	00111$
00180$:
;	.\src\main.c:444: rowloc = 0;
	mov	_rowloc,#0x00
;	.\src\main.c:445: break;
	sjmp	00120$
00111$:
;	.\src\main.c:448: __KEYPAD_PORT__ = 0xFD;
	mov	_P1,#0xfd
;	.\src\main.c:449: colloc = (__KEYPAD_PORT__ & 0xF0);
	mov	a,_P1
	anl	a,#0xf0
	mov	_colloc,a
;	.\src\main.c:450: if (colloc != 0xF0)
	mov	a,#0xf0
	cjne	a,_colloc,00181$
	sjmp	00113$
00181$:
;	.\src\main.c:452: rowloc = 1;
	mov	_rowloc,#0x01
;	.\src\main.c:453: break;
	sjmp	00120$
00113$:
;	.\src\main.c:456: __KEYPAD_PORT__ = 0xFB;
	mov	_P1,#0xfb
;	.\src\main.c:457: colloc = (__KEYPAD_PORT__ & 0xF0);
	mov	a,_P1
	anl	a,#0xf0
	mov	_colloc,a
;	.\src\main.c:458: if (colloc != 0xF0)
	mov	a,#0xf0
	cjne	a,_colloc,00182$
	sjmp	00115$
00182$:
;	.\src\main.c:460: rowloc = 2;
	mov	_rowloc,#0x02
;	.\src\main.c:461: break;
	sjmp	00120$
00115$:
;	.\src\main.c:464: __KEYPAD_PORT__ = 0xF7;
	mov	_P1,#0xf7
;	.\src\main.c:465: colloc = (__KEYPAD_PORT__ & 0xF0);
	mov	a,_P1
	anl	a,#0xf0
	mov	_colloc,a
;	.\src\main.c:466: if (colloc != 0xF0)
	mov	a,#0xf0
	cjne	a,_colloc,00183$
	sjmp	00119$
00183$:
;	.\src\main.c:468: rowloc = 3;
	mov	_rowloc,#0x03
;	.\src\main.c:469: break;
00120$:
;	.\src\main.c:473: if (colloc == 0xE0)
	mov	a,#0xe0
	cjne	a,_colloc,00128$
;	.\src\main.c:475: return (keypad[rowloc][0]);
	mov	a,_rowloc
	add	a,_rowloc
	add	a,acc
	add	a,#_keypad
	...
	ret
00128$:
;	.\src\main.c:477: else if (colloc == 0xD0)
	mov	a,#0xd0
	cjne	a,_colloc,00125$
;	.\src\main.c:479: return (keypad[rowloc][1]);
	mov	a,_rowloc
	add	a,_rowloc
	add	a,acc
	add	a,#_keypad
	...
	ret
00125$:
;	.\src\main.c:481: else if (colloc == 0xB0)
	mov	a,#0xb0
	cjne	a,_colloc,00122$
;	.\src\main.c:483: return (keypad[rowloc][2]);
	mov	a,_rowloc
	add	a,_rowloc
	add	a,acc
	add	a,#_keypad
	...
	ret
00122$:
;	.\src\main.c:487: return (keypad[rowloc][3]);
	mov	a,_rowloc
	add	a,_rowloc
	add	a,acc
	add	a,#_keypad
...
;------------------------------------------------------------
;	.\src\main.c:491: uint16_t reverse (uint8_t d) {
;	-----------------------------------------
;	 function reverse
;	-----------------------------------------
_reverse:
	mov	r7,dpl
;	.\src\main.c:492: uint16_t rev = 0;
	mov	r5,#0x00
	mov	r6,#0x00
;	.\src\main.c:494: while (d >= 1) {
00101$:
	cjne	r7,#0x01,00114$
00114$:
	jc	00103$
;	.\src\main.c:496: val = d%10;
	mov	ar3,r7
	mov	r4,#0x00
...
;------------------------------------------------------------
;	.\src\main.c:503: void asciiToDec (uint8_t d) {
;	-----------------------------------------
;	 function asciiToDec
;	-----------------------------------------
_asciiToDec:
;	.\src\main.c:506: id = reverse(d);
	lcall	_reverse
	mov	r6,dpl
	mov	r7,dph
;	.\src\main.c:507: while (id >= 1){
00101$:
	mov	ar4,r6
	mov	ar5,r7
	clr	c
...
;------------------------------------------------------------
;	.\src\main.c:516: void asciiToHex (uint8_t d) {
;	-----------------------------------------
;	 function asciiToHex
;	-----------------------------------------
_asciiToHex:
	mov	r7,dpl
;	.\src\main.c:520: store[0] = 0;
	mov	_asciiToHex_store_65536_200,#0x00
;	.\src\main.c:521: store[1] = 0;
	mov	(_asciiToHex_store_65536_200 + 0x0001),#0x00
;	.\src\main.c:522: while (d >= 1){
	mov	r6,#0x00
00104$:
	cjne	r7,#0x01,00122$
00122$:
	jc	00106$
;	.\src\main.c:524: val = d % 16;
	mov	ar4,r7
	mov	r5,#0x00
	mov	a,#0x0f
	anl	a,r4
	mov	r2,a
;	.\src\main.c:525: d = d/16;
...
;	1-genFromRTrack replaced	mov	(__divsint_PARM_2 + 1),#0x00
	...
	pop	ar6
	mov	ar7,r4
;	.\src\main.c:526: if (val <= 9) {
	mov	a,r2
	add	a,#0xff - 0x09
	jc	00102$
;	.\src\main.c:528: store[i] = val + '0';
	mov	a,r6
	...
	sjmp	00103$
00102$:
;	.\src\main.c:531: store[i] = (val%10) + 'A';
	mov	a,r6
	add	a,#_asciiToHex_store_65536_200
	mov	r1,a
	mov	r5,#0x00
...
;	.\src\main.c:533: i++;
	...
	sjmp	00104$
00106$:
;	.\src\main.c:535: write(store[1]);
	mov	dpl,(_asciiToHex_store_65536_200 + 0x0001)
	lcall	_write
;	.\src\main.c:536: write(store[0]);
...
;------------------------------------------------------------
;	.\src\main.c:539: void writeSomeLines () {
;	-----------------------------------------
;	 function writeSomeLines
;	-----------------------------------------
_writeSomeLines:
;	.\src\main.c:540: fillScreen(RED);
	mov	dptr,#0xf800
	lcall	_fillScreen
;	.\src\main.c:542: delay(20);
	mov	dptr,#0x0014
	lcall	_delay
;	.\src\main.c:543: fillScreen(GREEN);
	mov	dptr,#0x07e0
	lcall	_fillScreen
;	.\src\main.c:545: delay(20);
	mov	dptr,#0x0014
	lcall	_delay
;	.\src\main.c:547: setRotation(0);
	mov	dpl,#0x00
	lcall	_setRotation
;	.\src\main.c:548: fillScreen(BLACK);
	mov	dptr,#0x0000
	lcall	_fillScreen
;	.\src\main.c:549: testCircles(20, RED);
	mov	_testCircles_PARM_2,#0x00
	mov	(_testCircles_PARM_2 + 1),#0xf8
	mov	dpl,#0x14
	lcall	_testCircles
;	.\src\main.c:550: delay(100);
	mov	dptr,#0x0064
	lcall	_delay
;	.\src\main.c:551: fillScreen(BLACK);
	mov	dptr,#0x0000
	lcall	_fillScreen
;	.\src\main.c:552: setTextSize(5);
	mov	dpl,#0x05
	lcall	_setTextSize
;	.\src\main.c:553: setTextColor(CYAN, BLACK);
	clr	a
	mov	_setTextColor_PARM_2,a
	mov	(_setTextColor_PARM_2 + 1),a
	mov	dptr,#0x07ff
	lcall	_setTextColor
;	.\src\main.c:554: LCD_string_write("Welcome\n");
	mov	dptr,#___str_0
	mov	b,#0x80
	lcall	_LCD_string_write
;	.\src\main.c:555: setTextSize(3);
	mov	dpl,#0x03
	lcall	_setTextSize
;	.\src\main.c:556: LCD_string_write("ECEN-4330\n");
	mov	dptr,#___str_1
	mov	b,#0x80
	lcall	_LCD_string_write
;	.\src\main.c:557: LCD_string_write("Rotation 0");
	mov	dptr,#___str_2
	mov	b,#0x80
	lcall	_LCD_string_write
;	.\src\main.c:558: delay(200);
	mov	dptr,#0x00c8
	lcall	_delay
;	.\src\main.c:559: fillScreen(BLACK);
	mov	dptr,#0x0000
	lcall	_fillScreen
;	.\src\main.c:560: setRotation(1);
	mov	dpl,#0x01
	lcall	_setRotation
;	.\src\main.c:561: setCursor(0,0);
	clr	a
	mov	_setCursor_PARM_2,a
	mov	(_setCursor_PARM_2 + 1),a
	mov	dptr,#0x0000
	lcall	_setCursor
;	.\src\main.c:562: LCD_string_write("Rotation 1");
	mov	dptr,#___str_3
	mov	b,#0x80
	lcall	_LCD_string_write
;	.\src\main.c:563: delay(500);
	mov	dptr,#0x01f4
	lcall	_delay
;	.\src\main.c:564: fillScreen(BLACK);
	mov	dptr,#0x0000
	lcall	_fillScreen
;	.\src\main.c:565: setRotation(2);
	mov	dpl,#0x02
	lcall	_setRotation
;	.\src\main.c:566: setCursor(0,0);
	clr	a
	mov	_setCursor_PARM_2,a
	mov	(_setCursor_PARM_2 + 1),a
	mov	dptr,#0x0000
	lcall	_setCursor
;	.\src\main.c:567: LCD_string_write("Rotation 2");
	mov	dptr,#___str_4
	mov	b,#0x80
	lcall	_LCD_string_write
;	.\src\main.c:568: delay(500);
	mov	dptr,#0x01f4
	lcall	_delay
;	.\src\main.c:569: fillScreen(BLACK);
	mov	dptr,#0x0000
	lcall	_fillScreen
;	.\src\main.c:570: setRotation(3);
	mov	dpl,#0x03
	lcall	_setRotation
;	.\src\main.c:571: setCursor(0,0);
	clr	a
	mov	_setCursor_PARM_2,a
	mov	(_setCursor_PARM_2 + 1),a
	mov	dptr,#0x0000
	lcall	_setCursor
;	.\src\main.c:572: delay(200);
	mov	dptr,#0x00c8
	lcall	_delay
;	.\src\main.c:573: LCD_string_write("Rotation 3");
	mov	dptr,#___str_5
	mov	b,#0x80
	lcall	_LCD_string_write
;	.\src\main.c:574: delay(200);
	mov	dptr,#0x00c8
;	.\src\main.c:575: }
	ljmp	_delay
;------------------------------------------------------------
...
;	assignBit
	clr	_P3_5
;	.\src\main.c:580: IOM = 0;
;	assignBit
	clr	_P3_4
;	.\src\main.c:582: iowrite8(seg7_address, 0xC0);
	mov	_iowrite8_PARM_2,#0xc0
	mov	dpl,_seg7_address
	mov	dph,(_seg7_address + 1)
	lcall	_iowrite8
;	.\src\main.c:583: IOM = 0;
;	assignBit
	clr	_P3_4
;	.\src\main.c:584: CD = 1;
;	assignBit
	setb	_P3_5
;	.\src\main.c:586: TFT_LCD_INIT();
	lcall	_TFT_LCD_INIT
;	.\src\main.c:587: iowrite8(seg7_address, 0xF9);
	mov	_iowrite8_PARM_2,#0xf9
	mov	dpl,_seg7_address
	mov	dph,(_seg7_address + 1)
	lcall	_iowrite8
;	.\src\main.c:588: writeSomeLines();
	lcall	_writeSomeLines
;	.\src\main.c:589: setRotation(2);
	mov	dpl,#0x02
	lcall	_setRotation
;	.\src\main.c:590: fillScreen(GRAY);
	mov	dptr,#0xd6ba
	lcall	_fillScreen
;	.\src\main.c:591: setTextColor(BLACK, GRAY);
	mov	_setTextColor_PARM_2,#0xba
	mov	(_setTextColor_PARM_2 + 1),#0xd6
	mov	dptr,#0x0000
	lcall	_setTextColor
;	.\src\main.c:592: setCursor(0,0);
	clr	a
	mov	_setCursor_PARM_2,a
	mov	(_setCursor_PARM_2 + 1),a
	mov	dptr,#0x0000
	lcall	_setCursor
;	.\src\main.c:593: LCD_string_write("Free Type: \n");
	mov	dptr,#___str_6
	mov	b,#0x80
	lcall	_LCD_string_write
;	.\src\main.c:595: while(1) {
00102$:
;	.\src\main.c:596: freeType();
	lcall	_freeType
;	.\src\main.c:598: }
	sjmp	00102$
	.area CSEG    (CODE)
