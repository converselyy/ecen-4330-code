...
;------------------------------------------------------------
	G$lab4$0$0 ==.
	C$lab4.c$9$0_0$3 ==.
;	lab4.c:9: uint8_t lab4(uint8_t hex) {
;	-----------------------------------------
;	 function lab4
;	-----------------------------------------
_lab4:
...
00127$:
	...
	.db	00116$>>8
	C$lab4.c$11$2_0$4 ==.
;	lab4.c:11: case 0x0: return 0xC0; break;
00101$:
	mov	dpl,#0xc0
	C$lab4.c$12$2_0$4 ==.
;	lab4.c:12: case 0x1: return 0xF9; break;
	sjmp	00119$
00102$:
	mov	dpl,#0xf9
	C$lab4.c$13$2_0$4 ==.
;	lab4.c:13: case 0x2: return 0xA4; break;
	sjmp	00119$
00103$:
	mov	dpl,#0xa4
	C$lab4.c$14$2_0$4 ==.
;	lab4.c:14: case 0x3: return 0xB0; break;
	sjmp	00119$
00104$:
	mov	dpl,#0xb0
	C$lab4.c$15$2_0$4 ==.
;	lab4.c:15: case 0x4: return 0x99; break;
	sjmp	00119$
00105$:
	mov	dpl,#0x99
	C$lab4.c$16$2_0$4 ==.
;	lab4.c:16: case 0x5: return 0x92; break;
	sjmp	00119$
00106$:
	mov	dpl,#0x92
	C$lab4.c$17$2_0$4 ==.
;	lab4.c:17: case 0x6: return 0x82; break;
	sjmp	00119$
00107$:
	mov	dpl,#0x82
	C$lab4.c$18$2_0$4 ==.
;	lab4.c:18: case 0x7: return 0xF8; break;
	sjmp	00119$
00108$:
	mov	dpl,#0xf8
	C$lab4.c$19$2_0$4 ==.
;	lab4.c:19: case 0x8: return 0x80; break;
	sjmp	00119$
00109$:
	mov	dpl,#0x80
	C$lab4.c$20$2_0$4 ==.
;	lab4.c:20: case 0x9: return 0x90; break;
	sjmp	00119$
00110$:
	mov	dpl,#0x90
	C$lab4.c$21$2_0$4 ==.
;	lab4.c:21: case 0xA: return 0x88; break;
	sjmp	00119$
00111$:
	mov	dpl,#0x88
	C$lab4.c$22$2_0$4 ==.
;	lab4.c:22: case 0xB: return 0x83; break;
	sjmp	00119$
00112$:
	mov	dpl,#0x83
	C$lab4.c$23$2_0$4 ==.
;	lab4.c:23: case 0xC: return 0xC6; break;
	sjmp	00119$
00113$:
	mov	dpl,#0xc6
	C$lab4.c$24$2_0$4 ==.
;	lab4.c:24: case 0xD: return 0xA1; break;
	sjmp	00119$
00114$:
	mov	dpl,#0xa1
	C$lab4.c$25$2_0$4 ==.
;	lab4.c:25: case 0xE: return 0x86; break;
	sjmp	00119$
00115$:
	mov	dpl,#0x86
	C$lab4.c$26$2_0$4 ==.
;	lab4.c:26: case 0xF: return 0x8E; break;
	sjmp	00119$
00116$:
	mov	dpl,#0x8e
	C$lab4.c$27$2_0$4 ==.
;	lab4.c:27: default : return 0x00; break;
	sjmp	00119$
00117$:
	mov	dpl,#0x00
	C$lab4.c$28$1_0$3 ==.
